...
public class Algo2_frame extends JFrame {
	...
	public Algo2_frame(Database db) {
		...
		textField_Scan.setBounds(12, 42, 408, 22);
		...
		lblEnterMacs.setBounds(12, 77, 116, 16);
		...
		lblEnterSignals.setBounds(123, 77, 116, 16);
		...
		rdbtnSinglas.setBounds(255, 101, 127, 25);
